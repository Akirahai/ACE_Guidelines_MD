...
flowchart TD
    ...
    F --> I[See Recommendation 5]
    G --> J[Continues to have exacerbations & blood eosinophils ≥100 cells/μL]
    H --> J
    C --> K[If blood eosinophils ≥300 cells/μL]
    
    J --> L[Consider LAMA + LABA + ICS*]
    K --> L
    
    L --> M[See Recommendation 6 and 7]
```
