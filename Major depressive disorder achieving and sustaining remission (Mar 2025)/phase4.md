...
| :--- | :--- | :--- |
| ≤14 (typically in the range of 5 to 14) | • Duration of episode<br>• Comorbid mental health symptoms<br>• Functional impairment<br>• Risk of harm to self or others | Mild to moderate |
| 15–19 | • Duration of episode<br>• Comorbid mental health symptoms<br>• Functional impairment<br>• Risk of harm to self or others | Moderately severe |
| 20–27 | • Duration of episode<br>• Comorbid mental health symptoms<br>• Functional impairment<br>• Risk of harm to self or others | Severe |
...
```mermaid
flowchart TD
    A[ENTRY: Evaluate MDD Severity] --> B{Symptom Profile}
    A --> C{Functional Impairment}
    A --> D{Risk of Harm}
    B --> B1[Intensity: PHQ-9, clinical judgement]
    B --> B2[Duration: longer = greater severity]
    B --> B3[Comorbid: anxiety, addiction, personality, psychosis]
    C --> C1[Social interactions]
    C --> C2[School/workplace/household]
    C --> C3[Self-care/hygiene]
    D --> D1[To Self: Suicide ideation/intent/plans, history of attempts, substance abuse, ACEs, stressors]
    D --> D2[To Others: Intent/risk to harm others, history of aggressive behaviour]
    B1 --> E[MDD Severity]
    B2 --> E
    B3 --> E
    C1 --> E
